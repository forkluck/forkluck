"""Run queued supplier-connector document imports."""
...
from ...domains.invoices.connector_sync import process_next_run


class Command(BaseCommand):
    help = "Process queued supplier connector sync runs"
