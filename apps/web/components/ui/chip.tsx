...
const chipClassName =
  "inline-flex h-5 w-fit shrink-0 items-center gap-1 rounded-full border px-2 text-xs font-[550] whitespace-nowrap"
...
function Chip({
  ...
  const tone = pressed
    ...
    : "border-transparent bg-secondary-strong text-secondary-foreground"
