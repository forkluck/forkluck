 ...
 * side, and the component itself in every cell. The labels are 11.5px faint
          ...
          <tr>
            ...
            {columns.map((column) => (
              <th
                key={column}
                scope="col"
                className="px-3 pb-2 text-left align-bottom text-2xs font-medium text-faint"
              >
                {column}
              </th>
            ))}
        ...
        <tbody>
          {rows.map((row) => (
            <tr key={row}>
              <th
                scope="row"
                className="py-2 pr-4 text-left align-middle text-2xs font-medium whitespace-nowrap text-faint"
              >
                {row}
              </th>
              {columns.map((column) => (
