 ...
 * side, and the component itself in every cell. The labels are 13px subdued
          ...
          <tr>
            ...
            {columns.map((column) => (
              <th
                key={column}
                scope="col"
                className="px-3 pb-2 text-left align-bottom text-sm font-medium text-muted-foreground"
              >
                {column}
              </th>
            ))}
        ...
        <tbody>
          {rows.map((row) => (
            <tr key={row}>
              <th
                scope="row"
                className="py-2 pr-4 text-left align-middle text-sm font-medium whitespace-nowrap text-muted-foreground"
              >
                {row}
              </th>
              {columns.map((column) => (
