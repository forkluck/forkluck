...
const TOKENS: { token: string; value: string }[] = [
  ...
  { token: "--destructive-strong", value: "#7f1d1d" },
  { token: "--success", value: "#14532d" },
  { token: "--success-fill", value: "#eaf4ee" },
  { token: "--warning-foreground", value: "#431407" },
  { token: "--warning-fill", value: "#fed7aa" },
  { token: "--warning-border", value: "#fdba74" },
  { token: "--caution", value: "#ca8a04" },
  { token: "--caution-foreground", value: "#422006" },
  { token: "--caution-fill", value: "#fef9c3" },
  { token: "--info", value: "#1e3a8a" },
