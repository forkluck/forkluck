...
const TOKENS: { token: string; value: string }[] = [
  ...
  { token: "--destructive-fill", value: "#f6c4bd" },
  { token: "--destructive-strong", value: "#8f2a1f" },
  { token: "--success", value: "#2f5a3a" },
  { token: "--success-fill", value: "#cbe2b4" },
  { token: "--warning-foreground", value: "#7a3d0b" },
  { token: "--warning-fill", value: "#f9dca4" },
  { token: "--warning-border", value: "#f3c98a" },
  { token: "--caution", value: "#ca8a04" },
  { token: "--caution-foreground", value: "#6b5210" },
  { token: "--caution-fill", value: "#f6e58a" },
  { token: "--info", value: "#2b4c86" },
  { token: "--info-fill", value: "#c7d9f3" },
