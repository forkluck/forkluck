...
const TOKENS: { token: string; value: string }[] = [
  ...
  { token: "--destructive-fill", value: "#ffc1b8" },
  { token: "--destructive-strong", value: "#7a1f16" },
  { token: "--success", value: "#1f4a2b" },
  { token: "--success-fill", value: "#ccf1b1" },
  { token: "--success-mark", value: "#2f8f57" },
  { token: "--warning-foreground", value: "#612e06" },
  { token: "--warning-fill", value: "#f9dca4" },
  { token: "--warning-border", value: "#f3c98a" },
  { token: "--warning-mark", value: "#d97706" },
  { token: "--caution", value: "#ca8a04" },
  { token: "--caution-foreground", value: "#533d08" },
  { token: "--caution-fill", value: "#f7e06e" },
  { token: "--info", value: "#1f3a6b" },
  { token: "--info-fill", value: "#c2daff" },
